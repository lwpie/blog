...
相比理论带宽只有 70%，确认了内存工作在 3200 MHz 下
...
换用另一台 2 路 7H12 同内存配置服务器，速度同样为 280 GB/s，同 node 下 NUMA 140 GB/s. 换用 2 路 Intel 8368 同内存配置服务器，同 node 下 NUMA 带宽为 177 GB/s，为理论值的 88%，仍然无法到达理论值，但却相比 AMD 有所提升。
